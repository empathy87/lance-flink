    ...
    try {
      ...
      switch (indexType) {
        case IVF_PQ:
          ...
          indexParams = IndexParams.builder().setVectorIndexParams(ivfPqParams).build();
          break;
        ...
        case IVF_HNSW:
          ...
          indexParams = IndexParams.builder().setVectorIndexParams(ivfHnswParams).build();
          break;

        case IVF_FLAT:
          lanceIndexType = IndexType.IVF_FLAT;
          VectorIndexParams ivfFlatParams = VectorIndexParams.ivfFlat(numPartitions, distanceType);
          indexParams = IndexParams.builder().setVectorIndexParams(ivfFlatParams).build();
          break;
      ...
      IndexOptions indexOptions =
          IndexOptions.builder(Collections.singletonList(columnName), lanceIndexType, indexParams)
              .replace(replace)
              .withIndexName(null)
              .build();
